...
public class Constants {
    ...
    public static final class Overlay {
        ...
        public static final class State {
            public static final byte UNSET = -1; // Set to as default and never entered again
            // after the overlay was initialized successfully.
            public static final byte INITIALIZING = 1; // Set to while initializing the view
            // component for the overlay.
            public static final byte INITIALIZED = 2; // Set to when the overlay is ready.
            public static final byte ADDED = 3; // Set to after the overlay view component was
            // added to the screen.
            public static final byte SHOWING = 4; // Set to while the view is blending from
            // transparent to black.
            public static final byte VISIBLE = 5; // Set to when the overlay is visible but the
            // user is not interacting with it.
            public static final byte DRAGGING = 6; // Set to as soon as the user taps on the
            // touch screen and while he is dragging.
            public static final byte FALLING = 7; // Set to when the user releases the touch
            // screen but did not swipe upwards to hide the overlay. Remains while the falling down
            // animation is performed.
            public static final byte HIDING = 8; // Set to when the user releases the touch screen
            // and did swipe upwards to hide the overlay. Remains while the hiding animation is performed
            public static final byte HIDDEN = 9; // Set to when the overlay is invisible to the
            // user but still there.
            public static final byte REMOVED = 10; // Set to when the overlay view component was
            // removed from screen.
            // From here it jumps back to "ADDED" as soon as the service gets an intent to
    ...
    public static final class Notification {
        public static final int ID = 65432987; // Just some random ID for the
        // notification that is displayed when the device does not support QuickTiles.
        public static final String CHANNEL_ID = "default"; // Just some random ID
